...
Easily deploy restful-api applications to Tencent Cloud's serverless infrastructure using this Serverless Cloud Framework Component.
...
```bash
scf init restful-api --name example
cd example
```
